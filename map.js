 ...
 */
function setWikiText(title, marker) {
    var res;
    ...
    $.ajax({
        ...
        success: function(data) {
            populateInfoWindow(marker, data[2]);
        }

    }).fail(function(jqXHR, textStatus) {
        populateInfoWindow(marker, "failed to load resource");
 ...
 */
function populateInfoWindow(marker, description) {
    ...
    if (largeInfoWindow.marker != marker) {
        ...
        function getStreetView(data, status) {
            if (status == google.maps.StreetViewStatus.OK) {
                ...
                largeInfoWindow.setContent('<h3><center>' + marker.title + '</center></h3><div style="width: 320px; height: 100px" id="pano"></div>' +
                    '<hr/><p>' + description + '</p>');
                var panoramaOptions = {
                ...
                largeInfoWindow.setContent('<div>' + marker.title + '</div>' +
                    '<div>No Street View Found</div><hr/><p>' + description + '</p>');
